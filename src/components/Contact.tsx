...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "k.hemanth1999@gmail.com",
      link: "mailto:k.hemanth1999@gmail.com",
    },
    {
      icon: <Phone color="primary" />,
      title: "Phone",
      value: "+1 (469) 894-9461",
      link: "tel:+14698949461",
    },
    {
  ...
  const socialLinks = [
    {
      icon: <LinkedIn />,
      link: "https://www.linkedin.com/in/hemanth-krishna-/",
      color: "#0077b5",
      label: "LinkedIn",
    },
    {
      icon: <GitHub />,
      link: "https://github.com/HemanthKrishna1",
      color: "#24292e",
      label: "GitHub",
    },
    {
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <Typography variant="body2" color="text.secondary">
            © {new Date().getFullYear()} Hemanth Krishna. All rights reserved.
          </Typography>
        </Box>
      </Container>
